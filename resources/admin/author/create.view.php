        ...
        <div class="card">
            <div class="card-body">
                <div class="border p-3 rounded">
                    ...
                    <hr/>
                    <form action="<?php route("dashboard&author=store") ?>" method="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary" value="store" name="author">Save Info</button>
                            </div>
                        </div>

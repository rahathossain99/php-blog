    ...
    <div class="card">
        <div class="card-body">
            <div class="border p-3 rounded">
                ...
                <hr/>
                <form action="<?php route("dashboard&category=store") ?>" method="post"  class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary" value="store" name="category">Save Info</button>
                        </div>
                    </div>
